...
- Actualizado  : 2026-07-23 · Versión: 1.6 (incremental; los dos modos de `CommandDelivery` del GPS conviven en `Panel.razor` — corrige v1.5 — namespaces normalizados a `LibApp.*` y anclas de línea recalibradas; commit `@0ef370b` + cambios sin commitear, ver nota de sincronización)
